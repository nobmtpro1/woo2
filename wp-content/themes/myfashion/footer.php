               ...
               <div class="col-lg-3 col-md-6 col-sm-6">
                   <div class="footer__about">
                       <div class="footer__logo">
                           <a href="#"><img src="<?= bloginfo('template_directory') ?>/html/img/footer-logo.png" alt=""></a>
                       </div>
                       <p>The customer is at the heart of our unique business model, which includes design.</p>
                       <a href="#"><img src="<?= bloginfo('template_directory') ?>/html/img/payment.png" alt=""></a>
                   </div>
               </div>
   ...
   <script src="<?= bloginfo('template_directory') ?>/html/js/jquery.slicknav.js"></script>
