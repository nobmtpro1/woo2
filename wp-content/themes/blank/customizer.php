...
function add_input($wp_customize, $type, $section, $name)
{
...
function theme_name_register_theme_customizer($wp_customize)
{
    ...
    for ($i = 1; $i < 10; $i++) {
        add_input($wp_customize, 'text', 'banner', 'banner_title_' . $i);
        add_input($wp_customize, 'media', 'banner', 'banner_image_' . $i);
    }
    ...
    for ($i = 1; $i < 3; $i++) {
        add_input($wp_customize, 'text', 'category', 'category_name_' . $i);
        add_input($wp_customize, 'media', 'category', 'category_image_' . $i);
    }
}
